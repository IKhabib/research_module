...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Fifth_plot_third_simulation.png}
    \caption{Bias-Variance trade-off: OLS, PCR and PLS}
    \label{fig:PLS_analysis}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{First_plot_NIR.png}
    \caption{The original NIR spectra of 80 corn samples.}
    \label{fig:PLS_analysis}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Second_plot_NIR.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Third_plot_NIR.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Fifth_plot_NIR.png}
    \caption{Actual vs Fitted results of PCR and PLS}
    \label{fig:PLS_analysis}
\end{figure}
